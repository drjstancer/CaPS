        ...
        <div className="border-t-4 border-yellow-500 bg-white px-5 py-5">
          ...
          <div className="grid gap-6 lg:grid-cols-[300px_1fr]">
            ...
            <div className="space-y-4">
              ...
              {caseId === "case1" && station === 3 && tab === "Surgery Plan" && <Card><div className="mb-2 text-lg font-bold">Surgery Thinking</div><div className="grid gap-2 md:grid-cols-2">{["Remove tumor with margin", "Discuss risks and recovery with patient", "Ignore pathology findings", "Remove nothing"].map((o) => <Chip key={o} on={surgPick.includes(o)} onClick={() => toggleMulti(surgPick, o, setSurgPick)}>{o}</Chip>)}</div></Card>}
